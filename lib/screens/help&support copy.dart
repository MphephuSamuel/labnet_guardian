...
class _HelpSupportScreenState extends State<HelpSupportScreen> {
  static const String _sharePointVideoUrl =
      'https://universityofmpumalanga-my.sharepoint.com/:v:/g/personal/231111916_ump_ac_za/IQBwEeRMfM-6SqYF-Lc_TJBMAfbZU0j46VXkSMs-Xv5Pye0?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=v0imbr';

  int _videoLoadProgress = 0;
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Watch the full guide inside the app',
                        style: TextStyle(
                          fontSize: 13,
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: [
                  InAppWebView(
                    initialUrlRequest: URLRequest(url: WebUri(_sharePointVideoUrl)),
                    ...
                    onProgressChanged: (controller, progress) {
                      if (mounted) {
                        setState(() {
                          _videoLoadProgress = progress;
                        });
                      }
                    },
                  ),
                  if (_videoLoadProgress < 100)
                    const Center(
