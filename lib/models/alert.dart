...
extension AlertSeverityX on AlertSeverity {
  ...
  Color get color {
    switch (this) {
      ...
      case AlertSeverity.info:     return AppColors.info;
    }
  }

  Color get bgLight {
    switch (this) {
      case AlertSeverity.critical: return const Color(0xFFFFEBEB);
      case AlertSeverity.warning:  return const Color(0xFFFFF8EB);
      case AlertSeverity.info:     return const Color(0xFFEFF6FF);
    }
  }

  IconData get icon {
    switch (this) {
      case AlertSeverity.critical: return Icons.shield_outlined;
